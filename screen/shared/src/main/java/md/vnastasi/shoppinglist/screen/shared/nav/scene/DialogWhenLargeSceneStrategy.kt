package md.vnastasi.shoppinglist.screen.shared.nav.scene
...
@Composable
fun <T : Any> rememberDialogWhenLargeSceneStrategy(): DialogWhenLargeSceneStrategy<T> {
    val windowSizeClass = currentWindowAdaptiveInfoV2().windowSizeClass
    return remember(windowSizeClass) { DialogWhenLargeSceneStrategy(windowSizeClass) }
}

class DialogWhenLargeSceneStrategy<T : Any>(
